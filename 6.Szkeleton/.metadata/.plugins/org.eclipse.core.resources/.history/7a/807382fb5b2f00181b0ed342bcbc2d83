...
public class Test_8 {
    ...
    public void TEST_8_1() {
        ...
        celmezo1.Fogad(10,0,null, leptetheto2, null);
        
        Doboz leptetheto3 = new Doboz(new Palya(new Jatek()), celmezo2);
        celmezo2.Fogad(10,0,null, leptetheto3, null);
    ...
    public void TEST_8_3() {
        ...
        celmezo3.Fogad(10,0,null, leptetheto3, null);
    ...
    public void TEST_8_6() {
        ...
        celmezo4.Fogad(10,0,null, leptetheto4, null);
