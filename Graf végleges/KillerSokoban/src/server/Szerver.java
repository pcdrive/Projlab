...
public class Szerver {
	...
	/**
	 * Az osztaly konstruktora. letrehozza a a fifo csatornat a kesobbi
	 * parancsoknak, a kapcsolatok listajat,
	 * 
	 * @param j
	 *            A jatek osztaly referenciaja.
	 * @param p
	 *            A port szama, amin a beerkezo kapcsolatokat varjuk.
	 */
	public Szerver(Jatek j, String p) {
		...
		try {
			...
			// ha ilyen van az gaz, mert akkor hibas ip ment at az ellenorzesen. ( de nem
			// fog =) )
	 ...
	 *
	 * @param i
	 *            Irany amerre a jatekost leptetni kell
	 * @param nev
	 *            A jatekos neve.
	 */
	 ...
	 *
	 * @param k
	 *            Jatekadatok, amiket tovabbitani kell.
	 */
	public void SendAdat(KliensAdat k) {
		jatek.Print(k);
		for (Kapcsolat aKapcsolatok : kapcsolatok)
			aKapcsolatok.sendAdat(k);
	}
	...
	/**
	 * A szerver jatekinditasert felelos fuggvenye. bezarja a lobbit, es elinditja a
	 * jatekot a kivalasztott terkepfajl alapjan.
	 * 
	 * @param name
	 *            A szerver jatekosanak neve.
	 * @param name2
	 *            A szerver m�sodik jatekosanak neve.
	 */
	...
	/**
	 * A szerver lobbiert felelos fuggvenye. Elinditja a lobbit, ami alatt a
	 * kliensek csatlakozni tudnak.
	 *
	 * @param file
	 *            File amibol az adatokat be kell tolteni.
	 */
	...
	/**
	 * A jatek vegen az informaciot a palyatol a jatek fele tovabbitja, igy zarva le
	 * a jatekot.
	 */
	public void End() {
		run = false;
	 ...
	 * 
	 * @param k
	 *            A kapcsolat amit ki kell torolni a listabol.
	 */
